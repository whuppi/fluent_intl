...
CONTENT RULES (never change)
  ...
  • Links point only at IMMUTABLE targets — a PR, commit, or issue:
    ([#N](https://github.com/whuppi/fluent_intl/issues/N) reported by
    [@user](https://github.com/user), [PR #N](https://github.com/whuppi/fluent_intl/pull/N)).
...
First release — the zero-setup package:intl backend for fluent_bundle: CLDR plurals (42 inlined ordinal locales) and locale-aware number, currency, and date-time formatting.
